...
class Input_Gen(object):
    ...
    def __init__(self, df_train, df_test, cols_normalize, sequence_length, sequence_cols, sample_dir_path,
        ...
        norm_df = pd.DataFrame(min_max_scaler.fit_transform(df_train[cols_normalize].values),
        ...
        norm_test_df = pd.DataFrame(min_max_scaler.transform(df_test[cols_normalize].values), columns=cols_normalize,
                                    index=df_test.index)
